    ...
    class h {
      constructor(e, t = {}) {
        ...
        if (!(e instanceof Element))
          throw new Error(
            "Invalid element provided to NiceSelect - must be a valid DOM element"
          )
        ;(this.el = e),
          ...
          (this.placeholder =
            o(this.el, "placeholder") || this.config.placeholder),
          (this.searchtext =
            o(this.el, "searchtext") || this.config.searchtext),
          (this.selectedtext =
            o(this.el, "selectedtext") || this.config.selectedtext),
          (this.dropdown = null),
      ...
      destroy() {
        this.selectionList && this.#n(),
          this.dropdown &&
            (this.dropdown.remove(), this.el.classList.remove("hidden-select"))
      }
      focus(e = "") {
        var t
        if (
          (d(this.dropdown, "open")
            ? this.multiple
              ? e === this.dropdown.querySelector(".multiple-options") &&
      ...
      #a() {
        const e = [
          ...
          t = this.config.searchable
            ...
            : "",
          s = `\n      <div class="${e.join(" ")}" tabindex="${
            this.disabled ? "" : 0
          }">\n        <span class="${
            this.multiple ? "multiple-options" : "current"
          }"></span>\n        <div class="nice-select-dropdown">\n          ${t}\n          <ul class="list"></ul>\n        </div>\n      </div>\n    `
        this.el.insertAdjacentHTML("afterend", s),
      ...
      #c() {
        ...
        this.options.forEach((t) => {
          this.multiple && this.config.showSelectedItems && this.#h(t),
            e.appendChild(this.#p(t))
        })
      }
      #p(e) {
      ...
      #S() {
        ...
        e &&
          ...
          e.addEventListener("input", (e) => this.#g(e)))
      }
      #w(e) {
            ...
            null == s &&
              (s = Array.from(e.options).find(
                (e) =>
                  ...
                  String(t.data.value).trim().toLowerCase()
              )),
              null != s
                ? t.attributes.selected
                  ...
                  : (s.selected = !1)
                : console.warn(
                    `No matching option found for value: "${t.data.value}" in select element`,
                    e
                  )
          }),
      ...
      #g(e) {
        ...
        if ("" === t)
          this.options.forEach((e) => (e.element.style.display = ""))
        else if (d(this.dropdown, "open")) {
          const e = new RegExp(t)
          this.options.forEach((t) => {
            t.element.style.display = e.test(t.data.text.toLowerCase())
              ? ""
              : "none"
          })
        }
      ...
      #n() {
        null != this.selectionList &&
          (this.selectionList.remove(), (this.selectionList = null))
      }
      #h(e) {
        if (
          !this.multiple ||
        ...
        if (null == this.selectionList)
          ...
          null !=
          this.selectionList.querySelector(`[data-value="${e.data.value}"]`)
        )
          return
      ...
      #C(e) {
        ...
        if (
          (null != e.target && (e = e.target),
          null == e.matches || !e.matches(".remove-select-selection"))
        )
          return
